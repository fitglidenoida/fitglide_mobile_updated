...
class _HomeViewState extends State<HomeView> {
  // Declare state variables here within the _HomeViewState class
  ...
  Future<void> fetchHealthVitals(String username) async {
    try {
      // Fetch the health vitals data using the API
      final List<dynamic> healthVitalsList = await DataService().fetchHealthVitals(username);

      debugPrint('Health Vitals List: $healthVitalsList'); // Log the response
      ...
      if (weightKg == null || heightCm == null || dateOfBirth == null) {
        setState(() {
          bmiCategory = "Missing vital data for BMI calculation.";
          isLoading = false;
        });
        return;
      }
      ...
      // Calculate BMI
      final heightM = heightCm / 100.0; // Convert height from cm to meters
      final double calculatedBmi = weightKg / (heightM * heightM);

      // Calculate age from date_of_birth - you'll need to implement this function
      final int age = calculateAge(dateOfBirth);

      // Interpret BMI based on the calculated value and age
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              bmiCategory.isNotEmpty
                                  ? "Your weight status is $bmiCategory"
                          ...
                          AspectRatio(
                            ...
                            child: PieChart(
                              PieChartData(
                                ...
                                sectionsSpace: 1,
                                centerSpaceRadius: 0,
                                sections: showingSections(bmi ?? 0.0),
      ...
      switch (i) {
        case 0:
          return PieChartSectionData(
            ...
            badgeWidget: Text(
              bmi.toStringAsFixed(1), // Dynamically display the BMI
